<section class="about section" id="about">
    <div class="about__container conatiner grid">
       <div class="about__data">
          ...
          <p class="about__description">
             I'm an eager PHP and Laravel developer who is dedicated to making high-quality web apps. I love turning new ideas into code that can be used by many people and is easy to manage. I also like the challenge of using programming to solve hard problems.
          </p>
          <a href="{{ route('contact') }}" class="button">Contact Me</a>
       </div>

       <div class="about__image">
          <svg class="about__blob" viewBox="0 0 550 592" fill="none"
             ...
             <defs>
                ...
                <image class="about__img" id="imageBorder" width="690"
                   height="940" href="{{ asset('assets/img/hero.png') }}" />
             </defs>
          </svg>
       </div>
    </div>
